...
// Position Canvas behind the page
function centerCanvas() {
	var x = (windowWidth - width) / 2;
	var y = (windowHeight - height) / 2;
	cnv.position(0, 0);
...
Particle.prototype.display = function(other) {
  ...
  fill('rgba(238,199,25, 1)');//Side
  quad(this.position.x, this.position.y, 
      this.position.x, this.position.y - this.size, 
      this.position.x+87, this.position.y-50 - this.size, 
      this.position.x+87, this.position.y-50);

  fill('rgba(247,237,78, 1)');//Top 
  quad(this.position.x, this.position.y - this.size,
      this.position.x-87, this.position.y-50 - this.size,//point1 
      this.position.x, this.position.y-100 - this.size, //point2
      this.position.x+87, this.position.y-50 - this.size);//point3
